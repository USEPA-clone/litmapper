...
def upgrade():
    ...
    op.create_table('article_requester',
    ...
    op.create_index(op.f('ix_article_requester_article_id'), 'article_requester', ['article_id'], unique=False)

    op.create_table('article_set',
    ...
    op.create_table('article_article_set',
    sa.Column('article_id', sa.Integer(), nullable=False),
    sa.Column('article_set_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['article_id'], ['article.article_id'], ),
    sa.ForeignKeyConstraint(['article_set_id'], ['article_set.article_set_id'], ),
    sa.PrimaryKeyConstraint('article_id', 'article_set_id'),
    sa.UniqueConstraint('article_id', 'article_set_id'),
    sa.UniqueConstraint('article_id', 'article_set_id')
    )
    op.create_index(op.f('ix_article_article_set_article_id'), 'article_article_set', ['article_id'], unique=False)

    op.create_table('article_embedding',
    sa.Column('article_id', sa.Integer(), autoincrement=False, nullable=False),
    sa.Column('use_embedding', postgresql.ARRAY(sa.Float(), dimensions=1), nullable=False),
    sa.Column('specter_embedding', postgresql.ARRAY(sa.Float(), dimensions=1), nullable=True),
    sa.ForeignKeyConstraint(['article_id'], ['article.article_id'], ),
    sa.PrimaryKeyConstraint('article_id'),
    sa.UniqueConstraint('article_id', name='ucon_ae')
    )
    op.create_index(op.f('ix_article_embedding_article_id'), 'article_embedding', ['article_id'], unique=False)

    op.create_table('article_mesh_term',
    sa.Column('article_id', sa.Integer(), autoincrement=False, nullable=False),
    sa.Column('mesh_id', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['article_id'], ['article.article_id'], ),
    sa.ForeignKeyConstraint(['mesh_id'], ['mesh_term.mesh_id'], ),
    sa.UniqueConstraint('article_id', 'mesh_id')
    )
    op.create_index(op.f('ix_article_mesh_term_article_id'), 'article_mesh_term', ['article_id'], unique=False)

    op.create_table('article_temp_request',
    sa.Column('article_id', sa.Integer(), nullable=False),
    sa.Column('temp_request_id', sa.Integer(), nullable=False),
    sa.Column('is_article_temp', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['article_id'], ['article.article_id'], ),
    sa.ForeignKeyConstraint(['temp_request_id'], ['temp_request.temp_request_id'], ),
    sa.PrimaryKeyConstraint('article_id', 'temp_request_id'),
    sa.UniqueConstraint('article_id', 'temp_request_id'),
    sa.UniqueConstraint('article_id', 'temp_request_id')
    )
    op.create_index(op.f('ix_article_temp_request_article_id'), 'article_temp_request', ['article_id'], unique=False)

    op.create_table('concept_alias',
    sa.Column('concept_alias_id', sa.String(), nullable=False, comment='Unique key for the alias in the graph.'),
    sa.Column('concept_id', sa.String(), nullable=True),
    sa.Column('source_id', sa.String(), nullable=True),
    sa.Column('alias_name', sa.String(), nullable=False, comment='Name of the alias from the source vocabulary.'),
    sa.Column('source_concept_id', sa.String(), nullable=False, comment="The source's ID for this concept alias (ex MeSH ID for MeSH)."),
    sa.ForeignKeyConstraint(['concept_id'], ['concept_graph.concept.concept_id'], ),
    sa.ForeignKeyConstraint(['source_id'], ['concept_graph.source.source_id'], ),
    sa.PrimaryKeyConstraint('concept_alias_id'),
    schema='concept_graph'
    )

    op.create_table('concept_semantic_type',
    sa.Column('concept_id', sa.String(), nullable=True),
    sa.Column('semantic_type_id', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['concept_id'], ['concept_graph.concept.concept_id'], ),
    sa.ForeignKeyConstraint(['semantic_type_id'], ['concept_graph.semantic_type.semantic_type_id'], ),
...
def downgrade():
    ...
    op.drop_index(op.f('ix_article_temp_request_article_id'), table_name='article_temp_request')
    op.drop_table('article_temp_request')
    op.drop_index(op.f('ix_article_mesh_term_article_id'), table_name='article_mesh_term')
    op.drop_table('article_mesh_term')
    op.drop_index(op.f('ix_article_embedding_article_id'), table_name='article_embedding')
    op.drop_table('article_embedding')
    op.drop_index(op.f('ix_article_article_set_article_id'), table_name='article_article_set')
    ...
    op.drop_index(op.f('ix_article_requester_article_id'), table_name='article_requester')
